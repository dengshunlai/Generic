...
class WaterfallLayoutTestVC2: ProjBaseViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateWaterfallLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: WaterfallLayout, insetForHeaderInSection section: Int) -> UIEdgeInsets {
        if section == 0 {
            ...
            return UIEdgeInsets(top: 10, left: 100, bottom: 10, right: 100)
        }
        return .zero
    }
